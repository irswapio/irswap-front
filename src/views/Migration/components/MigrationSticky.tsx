...
const MigrationSticky: React.FC<React.PropsWithChildren<MigrationStickyProps>> = ({ step, handleClick }) => {
  ...
  const title: string = isStep1 ? t('Unstaking LP Tokens and IRS') : t('Stake in the new contract.')
  const subTitle: string = isStep1
    ? t('All the earned IRS will be harvested to your wallet upon unstake.')
