      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        ...
        <Flex flexDirection="column">
          ...
          <Box>
            <Box>
              <Text display="inline" color="#fff">
                {t('100% of the IRS paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </Box>
          </Box>
          <Heading
          ...
          <Box>
            <Box>
              <Text display="inline" color="#fff">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed IRS for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </Box>
          </Box>
          ...
          <Box>
            <Box>
              <Text display="inline" color="#fff">
                {t(
                  'An average total of 35,000 IRS from the treasury is added to lottery rounds over the course of a week. This IRS is of course also included in rollovers! Read more in our guide to IRS Tokenomics',
                )}
