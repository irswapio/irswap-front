...
const farms: SerializedFarmConfig[] = [
   ...
   */
   {
    ...
    v1pid: 0,
    lpSymbol: 'IRS',
    lpAddress: '0xE22f59fEcD16aB95aAC0fC7A2B7Eb82A93eF2182',
  ...
  },
  {
    ...
    v1pid: 1,
    lpSymbol: 'IRS-BNB LP',
    lpAddress: '0x4fcfa5A344A05a28d5a78C881991eBcaA669C482',
    token: bscTokens.irs,
    quoteToken: bscTokens.wbnb,
    boosted: true,
  },
  {
    pid: 2,
    v1pid: 2,
    lpSymbol: 'IRS-BUSD LP',
    lpAddress: '0xC3F508e351126021b87a6c9fDDD0561a1D5ED328',
    boosted: true,
    token: bscTokens.irs,
